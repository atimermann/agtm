...
export default class JobManager {
     ...
     */
    static "__#3@#isJobEnabled"(controller: JobsController): boolean;
    /**
     ...
     *
     */
    static "__#3@#configureSetupAndTeardownFunctions"(): void;
    /**
     ...
     */
    static "__#3@#filterFunctiontoJob"(job: Job): Array<JobSetupAndTeardownFunction>;
    /**
     ...
     *
     */
    static "__#3@#createScheduledWorkers"(): void;
    /**
     ...
     */
    static "__#3@#loadJobsAndWorkersFromController"(application: Application): Promise<void>;
    /**
     ...
     */
    static "__#3@#startScheduleJob"(): Promise<void>;
    /**
     ...
     */
    static "__#3@#schedulingJob"(job: Job): Promise<void>;
}
/**
