...
export default class ApplicationController {
     ...
     */
    static "__#8@#getControllersInstanceByApps"(appsPath: string, controllersType?: string[]): Promise<Array<BaseController>>;
    /**
     ...
     * @return {Promise<Array<BaseController>>}                  List of already instantiated controllers
     */
    static "__#8@#getControllersInstanceByControllers"(controllersPath: string): Promise<Array<BaseController>>;
    /**
